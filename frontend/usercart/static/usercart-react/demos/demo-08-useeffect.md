...
<head>
  <meta charset="UTF-8">
  <title>Demo 08 — useEffect 與物件 state</title>
...
<body>
  ...
  <script type="text/babel">
    ...
    function Products({ addToCart }) {
      ...
      if (loading) return <div className="container mt-4"><div className="spinner-border text-primary"/><span className="ms-2">載入中...</span></div>
