...
<head>
  <meta charset="UTF-8">
  <title>Demo 10 — Promise.all 與 Early Return</title>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5/dist/css/bootstrap.min.css">
  <style>
    .log-box { background:#1e1e1e; color:#d4d4d4; border-radius:6px; padding:10px;
               font-family:monospace; font-size:12px; min-height:50px; max-height:120px; overflow-y:auto; }
    .log-ok  { color:#4ec9b0; }
