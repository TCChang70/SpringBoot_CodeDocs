...
> 使用 `https://dummyjson.com` 免費假 API，無需後端即可執行。
...
<head>
  <meta charset="UTF-8">
  <title>Demo 05 — fetch + async/await</title>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5/dist/css/bootstrap.min.css">
  <style>
    .log-box { background:#1e1e1e; color:#d4d4d4; border-radius:6px; padding:12px;
               font-family:monospace; font-size:12px; min-height:60px; max-height:200px; overflow-y:auto; }
    .log-ok  { color:#4ec9b0; }
