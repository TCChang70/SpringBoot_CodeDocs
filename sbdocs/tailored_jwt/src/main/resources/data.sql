...
-- 3C 商品分類
INSERT INTO categories (id, name) VALUES (1, '手機');
INSERT INTO categories (id, name) VALUES (2, '筆記型電腦');
INSERT INTO categories (id, name) VALUES (3, '耳機與音訊');
INSERT INTO categories (id, name) VALUES (4, '相機');

-- 3C 商品（category_id 對應上方 categories.id）
INSERT INTO products (name, brand, price, stock, category_id) VALUES
...
INSERT INTO orders (order_no, customer_name, order_date, total_amount) VALUES
  ('ORD-20260701001', 'Alice', '2026-07-01 10:00:00', 47890.0),
  ('ORD-20260710002', 'Bob',   '2026-07-10 14:30:00', 59900.0);

INSERT INTO order_items (product_id, product_name, price, quantity, order_id) VALUES
